...
export const authRoutes = new Elysia({ prefix: '/auth' })
  ...
  .get(
    '/config',
    async () => {
      const databaseUrl = process.env.DATABASE_URL || 'postgresql://postgres:postgres@localhost:5432/band_together';
      return { databaseUrl };
    },
    {
      detail: {
        ...
        description: 'Get configuration information like database URL',
        responses: {
